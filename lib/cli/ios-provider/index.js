module.exports.command = 'ios-provider [serial..]'
...
module.exports.handler = function(argv) {
  ...
  , fork: function(device, ports) {
      ...
      , '--wda-port', ports.shift()
      , '--mjpeg-port', ports.shift()
      , '--wda-remote-port', argv.wdaPort
      , '--wda-mjpeg-remote-port', argv.wdaMjpegPort
  ...
  , wdaMjpegPort: argv.wdaMjpegPort
